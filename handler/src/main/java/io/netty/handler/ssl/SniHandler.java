...
public class SniHandler extends AbstractSniHandler<SslContext> {
     ...
     * users can override this method to implement io.netty.example.custom behavior.
     *
     ...
     * instance with a {@link SslHandler}. Users may override this method to implement io.netty.example.custom behavior.
     *
     * Please be aware that this method may get called after a client has already disconnected and
     * io.netty.example.custom implementations must take it into consideration when overriding this method.
     *
