...
abstract class AbstractChannelHandlerContext extends DefaultAttributeMap
    ...
    AbstractChannelHandlerContext(DefaultChannelPipeline pipeline, EventExecutor executor, String name,
        ...
        //如果由EventLoop或给定Executor驱动的是OrderedEventExecutor的实例，则它是有序的。
    ...
    //invokeWriteAndFlush基本等价于write方法之后再来一次flush
    ...
    private void write(Object msg, boolean flush, ChannelPromise promise) {
        ...
        if (executor.inEventLoop()) {
            ...
            /*
            外部线程在调用write的时候，executor.inEventLoop()会返回false，直接进入到else分支，将write封装成一个WriteTask
             */
    ...
    private void notifyHandlerException(Throwable cause) {
        //如果已经在 某一个channelhandler的exceptioncaught方法中了
    ...
    //如果已经在 exceptioncaught方法中，则返回ture
