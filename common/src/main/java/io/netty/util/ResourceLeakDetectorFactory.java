...
public abstract class ResourceLeakDetectorFactory {
    ...
    /**
     * Default implementation that loads io.netty.example.custom leak detector via system property
     */
    private static final class DefaultResourceLeakDetectorFactory extends ResourceLeakDetectorFactory {
        ...
        private static Constructor<?> obsoleteCustomClassConstructor(String customLeakDetector) {
            try {
                ...
                logger.error("Could not load io.netty.example.custom resource leak detector class provided: {}",
        ...
        public <T> ResourceLeakDetector<T> newResourceLeakDetector(Class<T> resource, int samplingInterval,
            ...
            if (obsoleteCustomClassConstructor != null) {
                try {
                    ...
                    logger.debug("Loaded io.netty.example.custom ResourceLeakDetector: {}",
                            obsoleteCustomClassConstructor.getDeclaringClass().getName());
                    return leakDetector;
                } catch (Throwable t) {
                    logger.error(
                            "Could not load io.netty.example.custom resource leak detector provided: {} with the given resource: {}",
