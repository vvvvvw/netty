...
public class Http2HeaderBlockIOTest {
    ...
    private static Http2Headers headers() {
        ...
        .authority(new AsciiString("example.org")).path(new AsciiString("/some/path/resource2"))
                .add(new AsciiString("accept"), new AsciiString("image/png"))
                .add(new AsciiString("cache-control"), new AsciiString("no-cache"))
                .add(new AsciiString("io.netty.example.custom"), new AsciiString("value1"))
                .add(new AsciiString("io.netty.example.custom"), new AsciiString("value2"))
                .add(new AsciiString("io.netty.example.custom"), new AsciiString("value3"))
                .add(new AsciiString("io.netty.example.custom"), new AsciiString("custom4"))
