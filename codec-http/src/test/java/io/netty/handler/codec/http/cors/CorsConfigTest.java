...
public class CorsConfigTest {
    ...
    public void exposeHeaders() {
        final CorsConfig cors = forAnyOrigin().exposeHeaders("io.netty.example.custom-header1", "io.netty.example.custom-header2").build();
        assertThat(cors.exposedHeaders(), hasItems("io.netty.example.custom-header1", "io.netty.example.custom-header2"));
    }
